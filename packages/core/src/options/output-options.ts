...
function normalizeFormat(format: OutputOptions['format']): BindingOutputOptions['format'] {
...
export function normalizeOutputOptions(opts: OutputOptions): BindingOutputOptions {
