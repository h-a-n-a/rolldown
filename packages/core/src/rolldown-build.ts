import { Bundler, type InputOptions as BindingInputOptions } from '@rolldown/node-binding'
...
import type { RollupBuild, RollupOutput, SerializedTimings } from './rollup-types'
...
export class RolldownBuild implements RollupBuild {
    ...
    static async fromInputOptions(inputOptions: InputOptions): Promise<RolldownBuild> {
        const bindingOptions: BindingInputOptions = await normalizeInputOptions(inputOptions)
